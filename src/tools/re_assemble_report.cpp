...
constexpr std::array selections{
    ...
    Selection{0x00DEEC, 0x00DF52, "M12_2_CODE_CONFIRMED", "M12.2 static CFG; indirect JSR recorded", "UNKNOWN"},
    Selection{0x00E0B8, 0x00E0BA, "M12_2_CODE_CONFIRMED", "M12.2 static bounded RTS", "UNKNOWN"},
    Selection{0x00E0BA, 0x00E0F4, "M12_2_CODE_CONFIRMED", "M12.2 static CFG; indirect JSR recorded", "UNKNOWN"},
    Selection{0x00E0F4, 0x00E0FE, "M12_2_CODE_CONFIRMED", "M12.2 direct dispatch-prefix evidence", "UNKNOWN"},
    Selection{0x00E106, 0x00E140, "M12_2_CODE_CONFIRMED", "M12.2 static CFG; indirect JSR recorded", "UNKNOWN"},
    Selection{0x00E268, 0x00E2A2, "M12_2_CODE_CONFIRMED", "M12.2 21 observed PCs; ADDX normalized", "UNKNOWN"},
    Selection{0x00E2A2, 0x00E2BA, "M12_2_CODE_CONFIRMED", "M12.2 observed caller; MULU normalized", "UNKNOWN"},
    Selection{0x00E2D4, 0x00E2F0, "M12_2_CODE_CONFIRMED", "M12.2 exact dispatch prefix; JMP remains unresolved", "UNKNOWN"},
    Selection{0x00E302, 0x00E308, "M12_2_CODE_CONFIRMED", "M12.2 observed case arm", "UNKNOWN"},
    Selection{0x00E308, 0x00E30C, "M12_2_CODE_CONFIRMED", "M12.2 observed case arm", "UNKNOWN"},
    Selection{0x00E30C, 0x00E310, "M12_2_CODE_CONFIRMED", "M12.2 observed case arm", "UNKNOWN"},
    Selection{0x00E310, 0x00E316, "M12_2_CODE_CONFIRMED", "M12.2 observed case arm", "UNKNOWN"},
    Selection{0x00E332, 0x00E338, "M12_2_CODE_CONFIRMED", "M12.2 shared restore/RTS tail", "UNKNOWN"},
