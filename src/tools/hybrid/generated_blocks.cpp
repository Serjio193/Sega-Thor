...
unsigned instruction_count_from_0x002D66(unsigned entry_pc) {
    if (entry_pc == 0x002D66U) return 7U;
    if (entry_pc == 0x002D6AU) return 6U;
    if (entry_pc == 0x002D6CU) return 5U;
    if (entry_pc == 0x002D6EU) return 4U;
    if (entry_pc == 0x002D74U) return 3U;
    if (entry_pc == 0x002D76U) return 2U;
    if (entry_pc == 0x002D78U) return 1U;
    return 0;
}

BlockExit execute_0x002D66(BasicBlockApi& api, unsigned entry_pc) {
    unsigned instructions_executed = 0;
    bool execute_from_here = false;
    if (entry_pc != 0x002D66U && entry_pc != 0x002D6AU && entry_pc != 0x002D6CU && entry_pc != 0x002D6EU && entry_pc != 0x002D74U && entry_pc != 0x002D76U && entry_pc != 0x002D78U) return {entry_pc, BlockExitReason::FALLBACK, 0};
    if (execute_from_here || entry_pc == 0x002D66U) {
    ...
    if (execute_from_here || entry_pc == 0x002D6AU) {
    ...
    if (execute_from_here || entry_pc == 0x002D6CU) {
    ...
    if (execute_from_here || entry_pc == 0x002D6EU) {
    ...
    if (execute_from_here || entry_pc == 0x002D74U) {
    ...
    if (execute_from_here || entry_pc == 0x002D76U) {
    ...
    if (execute_from_here || entry_pc == 0x002D78U) {
...
unsigned instruction_count_from_0x0604BC(unsigned entry_pc) {
    if (entry_pc == 0x0604BCU) return 1U;
    return 0;
}

BlockExit execute_0x0604BC(BasicBlockApi& api, unsigned entry_pc) {
    unsigned instructions_executed = 0;
    bool execute_from_here = false;
    if (entry_pc != 0x0604BCU) return {entry_pc, BlockExitReason::FALLBACK, 0};
    if (execute_from_here || entry_pc == 0x0604BCU) {
...
unsigned instruction_count_from_0x061032(unsigned entry_pc) {
    if (entry_pc == 0x061032U) return 1U;
    return 0;
}

BlockExit execute_0x061032(BasicBlockApi& api, unsigned entry_pc) {
    unsigned instructions_executed = 0;
    bool execute_from_here = false;
    if (entry_pc != 0x061032U) return {entry_pc, BlockExitReason::FALLBACK, 0};
    if (execute_from_here || entry_pc == 0x061032U) {
...
unsigned instruction_count_from_0x03A85E(unsigned entry_pc) {
    if (entry_pc == 0x03A85EU) return 1U;
    return 0;
}

BlockExit execute_0x03A85E(BasicBlockApi& api, unsigned entry_pc) {
    unsigned instructions_executed = 0;
    bool execute_from_here = false;
    if (entry_pc != 0x03A85EU) return {entry_pc, BlockExitReason::FALLBACK, 0};
    if (execute_from_here || entry_pc == 0x03A85EU) {
...
unsigned instruction_count_from_0x03A8BA(unsigned entry_pc) {
    if (entry_pc == 0x03A8BAU) return 1U;
    return 0;
}

BlockExit execute_0x03A8BA(BasicBlockApi& api, unsigned entry_pc) {
    unsigned instructions_executed = 0;
    bool execute_from_here = false;
    if (entry_pc != 0x03A8BAU) return {entry_pc, BlockExitReason::FALLBACK, 0};
    if (execute_from_here || entry_pc == 0x03A8BAU) {
...
unsigned instruction_count_from_0x03A88C(unsigned entry_pc) {
    if (entry_pc == 0x03A88CU) return 1U;
    return 0;
}

BlockExit execute_0x03A88C(BasicBlockApi& api, unsigned entry_pc) {
    unsigned instructions_executed = 0;
    bool execute_from_here = false;
    if (entry_pc != 0x03A88CU) return {entry_pc, BlockExitReason::FALLBACK, 0};
    if (execute_from_here || entry_pc == 0x03A88CU) {
