...
class Callee61934Observer {
public:
    explicit Callee61934Observer(CallerAttributionApi api);
...
private:
    struct Effect { unsigned pc{}, address{}, type{}, width{}, count{}; };
    ...
    std::array<unsigned, 6> parent_calls_{};
    std::array<unsigned, 6> parent_returns_{};
