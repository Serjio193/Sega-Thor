...
**Validation:** M14.2A 3/3; M14.2B fusion 4/4; M14.2C closure 3/3; M14.3 2/2; M14.4 closure 2/2; M14.5 2/2; M14.6 Stage7 contract 4/4; knowledge pipeline 18/18; MASTER V2 3/3; canonical materialization 3/3. Debug build/full CTest PASS (215/215); Release build/full CTest PASS (215/215), including `project_file_line_limit` in both. The accepted-ROM exact source/roundtrip campaign and deterministic two-child replay pass. Fresh detached worktree `aefb4d0` configured successfully, built `oasis_re_cfg_closure_test`, passed the M14.6 contract (4/4) and source-limit CTest (2/2). `git diff --check` passes. Branch commit is ready for publication; remote verification is pending.
