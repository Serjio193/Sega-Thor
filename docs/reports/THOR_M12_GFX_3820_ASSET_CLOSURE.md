...
| `0x03C07C` | 0x03C04C resource family | `A0 = 0x00172168 direct ROM literal; A1 inherited at shared family entry` | `0x00172168` | indirect/RAM | BLOCKED: A1_INHERITED_NOT_ROM_PROVEN |
