...
|---|---|---|---|
| V2.1-001 | VERIFIED | Coverage accepted arbitrary tagged event dictionaries as a verified basis. | Content-attested event/basis hashes; `test_unattested_historical_tags_cannot_create_verified_coverage`. |
...
| V2.1-004 | REGRESSION_ADDED | Legacy V1 target was not required to bind to concrete V2 byte outputs. | Identity-checked causal_bridge and adversarial detachment regression. |
